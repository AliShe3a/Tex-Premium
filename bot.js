...
bot.on(`ready`, () => {
	...
	bot.user.setActivity(`Music | ${prefix}`, { type: "streaming", url: "https://www.twitch.tv/aligamer889" });
});
  ...
  switch (args[0].toLowerCase()) {
    case "mhelp":
      ...
      let em = new Discord.RichEmbed()
        ...
        .setDescription("Fine I'm a simple musicbot by ٍShe3a_YT🎓#6776 *that's only about 300 lines.*")
